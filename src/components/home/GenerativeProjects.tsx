      ...
      <div className="relative flex flex-col h-full p-1">
        ...
        <div className="relative h-48 bg-card border-b border-card-border p-6 overflow-hidden group-hover:bg-muted transition-colors">
           ...
           <div className="relative z-10 flex flex-col h-full justify-end">
              <span className="text-xs text-muted-foreground mb-2">Project {(index + 1).toString().padStart(2, '0')}</span>
              <h3 className="text-xl font-bold text-foreground tracking-tight group-hover:text-foreground/80 transition-colors">
                 {project.title}
              </h3>
           </div>
        </div>
